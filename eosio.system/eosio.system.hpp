...
namespace eosiosystem {
   ...
   class system_contract : public native {
      ...
      public:
         ...
         void regproducer( const account_name producer, const public_key& producer_key, std::string maximum_supply, double transfer_ratio, const std::string& url, uint16_t location );
