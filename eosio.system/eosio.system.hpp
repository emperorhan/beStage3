...
namespace eosiosystem {
   ...
   struct eosio_global_state : eosio::blockchain_parameters {
      ...
      int64_t              temp_debug[10];
      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE_DERIVED( eosio_global_state, eosio::blockchain_parameters,
                                (max_ram_size)(total_ram_bytes_reserved)(total_ram_stake)
                                (last_producer_schedule_update)(last_pervote_bucket_fill)
                                (pervote_bucket)(perblock_bucket)(total_unpaid_blocks)(total_activated_stake)(thresh_activated_stake_time)
                                (last_producer_schedule_size)(total_producer_vote_weight)(last_name_close)(temp_debug) )
   };
   ...
   struct producer_info {
      ...
      //    return ret;
      // }
      // double   by_votes()const    { return is_active ? -get_vote_weight() : get_vote_weight();  }
   ...
   class system_contract : public native {
      ...
      public:
         ...
         void regproducer( const account_name producer, const eosio::public_key& producer_key, asset transfer_ratio, const std::string& url, uint16_t location );

         // void updateprod( const account_name producer, const eosio::public_key& producer_key, asset transfer_ratio, const std::string& url, uint16_t location );

         // void regproducer( const account_name producer, const eosio::public_key& producer_key, int64_t amount, const std::string& sym, double transfer_ratio, const std::string& url, uint16_t location );

         // void updateprod( const account_name producer, const eosio::public_key& producer_key, double transfer_ratio, const std::string& url, uint16_t location );

         // void regproducer( const account_name producer, const eosio::public_key& producer_key, asset transfer_ratio, const std::string& sym, const std::string& url, uint16_t location );
